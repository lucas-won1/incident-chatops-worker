...
import { requiredString, selectOne } from "./sqlite-rows.js"
import type { CompleteJobInput, JobClaimInput, JobClaimRecord } from "./types.js"

const globalLeaseName = "default"

const findJobByActionKey = (
  db: Database,
...
export const claimJobForSlackAction = (
  ...
  transaction(db, path, () => {
    const existing = findJobByActionKey(db, input.actionIdempotencyKey)
